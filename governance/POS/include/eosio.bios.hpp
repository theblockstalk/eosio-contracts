   ...
   class [[eosio::contract("eosio.bios")]] bios : public eosio::contract {
      public:
         ...
         TABLE producer_info {
            ...
            uint64_t primary_key()const { return owner.value;  }
            double   by_stake()const    { return total_stake;  }
         ...
         typedef eosio::multi_index< "producers"_n, producer_info,
                               indexed_by<"stakeamount"_n, const_mem_fun<producer_info, double, &producer_info::by_stake>  >
                             > producers_table;
         ...
         const static uint8_t NUMBER_PRODUCERS = 100;
